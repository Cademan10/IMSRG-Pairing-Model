Code I developed for obtaining the ground state energy of the nuclear pairing model using the in medium similarity renormalization group (IMSRG), located in IMSRG_Flow_Eqs_code.py. 
